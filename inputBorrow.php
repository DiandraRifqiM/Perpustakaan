...
<h2>Pinjam buku</h2>
<p class="lead">Silakan Isi Data Peminjaman Buku.</p>
</div>
<div class="row g-5">
<div class="col-md-12 col-lg-12">
<h4 class="mb-3">Data Peminjaman</h4>
<form class="needs-validation" novalidate method="post"
action="addBorrow.php">
<div class="row g-3">
<div class="col-12">
...
echo "<option
value=".$row['book_id'].">".$row['title']."</option>";
}
?>
</select>
</div>
...
while ($row = $result->fetch_assoc()) {
echo "<option
value=".$row['member_id'].">".$row['first_name']."</option>";
}
?>
</select>
</div>
<button class="w-100 btn btn-primary btn-lg" type="submit">Pinjam
buku</button>
</form>
</div>
</div>
