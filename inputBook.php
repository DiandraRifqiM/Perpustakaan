...
<header class="header">
      ...
      <ul class="main-nav">
          ...
          <li><a href="updateBook.php">Perbarui Buku</a></li>
      </ul>
	</header> 
...
id="title" placeholder="Judul" value="" required>
...
id="author" placeholder="Penulis" required>
<div class="invalid-feedback">
...
type="submit">Tambahkan buku</button>
</form>
</div>
        </main>
    </div>
