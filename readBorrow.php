...
<a href="inputBorrow.php" class="btn btn-primary my-2">Pinjam
buku</a>
</div>
<div class="row g-5">
...
$sql = "SELECT borrow.borrow_id, book.title,
member.first_name, borrow.status FROM borrow
...
btn-primary'
href='updateBorrow.php?borrow_id=".$row['borrow_id']."'>Update</button>"."
</td";
echo "<td>"."<a type='button' class='btn
btn-danger'
href='deleteBorrow.php?borrow_id=".$row['borrow_id']."'>Hapus</button>"."<
/td";
echo "</tr>";
}
} else {
